      ...
      <div className="max-w-2xl mx-auto">
        ...
        >
          ...
          <div className="flex justify-center space-x-3 sm:space-x-4">
            <button
              onClick={() => navigate('/')}
              className="btn-secondary text-sm sm:text-base px-4 sm:px-6 py-2"
            >
              返回首页
            </button>
            <button
    ...
    <div className="max-w-3xl mx-auto pb-40 sm:pb-24">
      ...
      <AnimatePresence mode="wait">
        <motion.div
          ...
          className="card p-4 sm:p-6 lg:p-8 mb-4 sm:mb-6"
        >
          <h2 className="text-base sm:text-lg lg:text-xl font-medium text-gray-900 mb-4 sm:mb-6">
              ...
              return (
                ...
                >
                  <div className="flex items-center space-x-2 sm:space-x-3">
                    <div
                      className={`w-6 h-6 sm:w-8 sm:h-8 rounded-full border-2 flex items-center justify-center font-medium text-xs sm:text-sm ${
                        currentFeedback
                          ? isCorrectAnswer
        ...
        {currentFeedback && (
          ...
          >
            ...
            <div className="bg-white rounded-lg p-3 sm:p-4 mb-3 sm:mb-4">
              ...
              <div className="prose prose-xs sm:prose-sm text-gray-600 whitespace-pre-line">
            ...
            <div className="bg-white rounded-lg p-3 sm:p-4">
              ...
              <div className="flex flex-wrap gap-1.5 sm:gap-2">
                {currentFeedback.analysis.knowledgePoints.map((kp) => (
                  <span
                    key={kp.id}
                    className="px-2.5 sm:px-3 py-1 rounded-full text-xs sm:text-sm bg-primary bg-opacity-10 text-primary"
                  >
            ...
            <div className="mt-3 sm:mt-4 p-2 sm:p-3 bg-blue-50 rounded-lg text-xs sm:text-sm text-blue-700">
              💡 系统已将此题目加入间隔重复队列，预计{' '}
              {(() => {
      ...
      <div className="fixed left-0 right-0 bg-white border-t border-gray-200 p-3 sm:p-4 z-[100] bottom-[56px] md:bottom-0">
        <div className="max-w-3xl mx-auto flex justify-between gap-3">
          <button
            ...
            className="btn-secondary flex items-center space-x-1 sm:space-x-2 px-3 sm:px-4 py-2.5 sm:py-2"
          >
            <ArrowLeft className="w-4 h-4 sm:w-5 sm:h-5" />
            <span className="text-xs sm:text-sm hidden sm:inline">退出练习</span>
          </button>
          ...
          {!currentFeedback ? (
            <button
              ...
              className="btn-primary flex-1 flex items-center justify-center space-x-1 sm:space-x-2 disabled:opacity-50 disabled:cursor-not-allowed px-4 sm:px-6 py-2.5 sm:py-2"
            >
              <span className="text-sm sm:text-base">提交答案</span>
            </button>
          ) : session.currentIndex === session.questions.length - 1 ? (
            <button
              onClick={finishPractice}
              className="btn-primary flex-1 flex items-center justify-center space-x-1 sm:space-x-2 px-4 sm:px-6 py-2.5 sm:py-2"
            >
              <span className="text-sm sm:text-base">完成练习</span>
            </button>
          ) : (
            <button
              ...
              className="btn-primary flex-1 flex items-center justify-center space-x-1 sm:space-x-2 px-4 sm:px-6 py-2.5 sm:py-2"
            >
              <span className="text-sm sm:text-base">下一题</span>
